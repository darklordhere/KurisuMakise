...
from KurisuMakise.plugins.helper_funcs.extraction import extract_user
from KurisuMakise.plugins.helper_funcs.filters import CustomFilters
from KurisuMakise.plugins.helper_funcs.alternate import typing_action
from KurisuMakise import dispatcher, MAKISE_OWN, RINTAROU, LOGGER
from KurisuMakise.plugins.disable import DisableAbleCommandHandler, DisableAbleMessageHandler

import KurisuMakise.plugins.helper_funcs.fun_strings as fun
...
def gbun(update, context):
    ...
    if update.effective_message.chat.type == "private":
        return
    if int(user.id) in MAKISE_OWN or int(user.id) in MAYURI:
