...
from KurisuMakise.__main__ import STATS, TOKEN, USER_INFO
import KurisuMakise.modules.sql.userinfo_sql as sql
from KurisuMakise.modules.disable import DisableAbleCommandHandler
from KurisuMakise.modules.sql.global_bans_sql import is_user_gbanned
from KurisuMakise.modules.sql.afk_sql import is_afk, check_afk_status
from KurisuMakise.modules.sql.users_sql import get_user_num_chats
from KurisuMakise.modules.sql.feds_sql import get_user_fbanlist
from KurisuMakise.modules.helper_funcs.chat_status import sudo_plus
from KurisuMakise.modules.helper_funcs.extraction import extract_user
from KurisuMakise import telethn as KurisuMakiseTelethonClient, TIGERS, DRAGONS, DEMONS
...
def info(update: Update, context: CallbackContext):
    ...
    rep = message.reply_text(
        "<code>Accessing Telegram Database...</code>", parse_mode=ParseMode.HTML)
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/KurisuMakiseUpdates/23">?</a>]'.format(
            bot.username)
 ...
 *What Health means?*
  Come and see [HP System explained](https://t.me/KurisuMakiseUpdates/24).
"""
