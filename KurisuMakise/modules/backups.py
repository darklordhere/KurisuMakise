...
import KurisuMakise.modules.sql.notes_sql as sql
from KurisuMakise import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from KurisuMakise.__main__ import DATA_IMPORT
from KurisuMakise.modules.helper_funcs.chat_status import user_admin
from KurisuMakise.modules.helper_funcs.alternate import typing_action

# from KurisuMakise.modules.rules import get_rules
import KurisuMakise.modules.sql.rules_sql as rulessql

# from KurisuMakise.modules.sql import warns_sql as warnssql
import KurisuMakise.modules.sql.blacklist_sql as blacklistsql
from KurisuMakise.modules.sql import disable_sql as disabledsql

# from KurisuMakise.modules.sql import cust_filters_sql as filtersql
# import KurisuMakise.modules.sql.welcome_sql as welcsql
import KurisuMakise.modules.sql.locks_sql as locksql
...
def export_data(update, context):
    ...
    with open("IndiBots{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("IndiBots{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Bot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("IndiBots{}.backup".format(chat_id))  # Cleaning file
