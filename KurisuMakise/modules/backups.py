...
from KurisuMakise import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER
...
def export_data(update, context):
    ...
    f = open("KurisuMakise{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("KurisuMakise{}.backup".format(chat_id), "rb"),
    ...
    os.remove("KurisuMakise{}.backup".format(chat_id))  # Cleaning file
