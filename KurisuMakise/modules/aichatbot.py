...
import requests
import re
from KurisuMakise import pbot as LYCIA
...
async def lycia(client, message):
    ...
    if chat_id in en_chats:
        ...
        result = result.replace("My dear great botmaster, Lyciabot Team.")
...
async def redaura(client, message):
    ...
    result = result.replace('{"cnt":"', "")
    result = result.replace('"}', "")
    result = result.replace("Aco", "anime")
    result = result.replace("Eliza", "BOT")
    result = result.replace("Hi~", "Hello Friend I Am BOT")
    result = result.replace("My dear great botmaster")
    result = result.replace("Have the control right.")
    result = result.replace("I was created by Lyciabot Team.")
    result = result.replace("<a href=\\", "<a href =")
    result = result.replace("<\/a>", "</a>")
