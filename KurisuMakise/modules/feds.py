...
import KurisuMakise.modules.sql.feds_sql as sql
...
from KurisuMakise.modules.helper_funcs.string_handling import markdown_parser
        ...
        if args[0] == "json":
            ...
            with BytesIO(str.encode(backups)) as output:
                ...
                update.effective_message.reply_document(
                    document=output,
                    filename="bot_fbanned_users.json",
            ...
            with BytesIO(str.encode(backups)) as output:
                ...
                update.effective_message.reply_document(
                    document=output,
                    filename="bot_fbanned_users.csv",
