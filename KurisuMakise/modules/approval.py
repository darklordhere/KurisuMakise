...
from KurisuMakise import dispatcher, DRAGONS
from KurisuMakise.modules.helper_funcs.extraction import extract_user
from telegram.ext import CallbackContext, run_async, CallbackQueryHandler
import KurisuMakise.modules.sql.approve_sql as sql
...
__help__ = """
By approving a user, you basically make them immpune to all the automated functions that can restrict them. Such as flood or auto warn. 
