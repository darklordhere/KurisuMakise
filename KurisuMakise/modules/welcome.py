...
import KurisuMakise.modules.sql.welcome_sql as sql
...
from KurisuMakise.modules.helper_funcs.misc import build_keyboard, revert_buttons
from KurisuMakise.modules.helper_funcs.msg_types import get_welcome_type
from KurisuMakise.modules.helper_funcs.string_handling import (
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            if left_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "Watcher left.", reply_to_message_id=reply)
                return
