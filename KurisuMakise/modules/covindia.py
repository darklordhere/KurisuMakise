...
from KurisuMakise import pbot as app
from KurisuMakise.pyrogramee.errors import capture_err
from KurisuMakise.pyrogramee.json_prettify import json_prettify
from KurisuMakise.pyrogramee.fetch import fetch
