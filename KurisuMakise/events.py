...
from KurisuMakise import MONGO_DB_URI
from KurisuMakise import telethn
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import KurisuMakise.events

        path = Path(f"KurisuMakise/modules/{shortname}.py")
        name = "KurisuMakise.modules.{}".format(shortname)
        ...
        mod.KurisuMakise = KurisuMakise
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["KurisuMakise.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "KurisuMakise/modules/*.py"
