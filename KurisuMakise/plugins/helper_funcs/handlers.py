import KurisuMakise.plugins.sql.blacklistusers_sql as sql
from KurisuMakise import ALLOW_EXCL
from KurisuMakise import (RINTAROU, MAKISE_OWN, MAYURI, FARIS, SUZUHA)
...
class AntiSpam:
    ...
    def __init__(self):
        self.whitelist = (RINTAROU or []) + (MAKISE_OWN or []) + (
            SUZUHA or []) + (MAYURI or []) + (
                FARIS or [])
