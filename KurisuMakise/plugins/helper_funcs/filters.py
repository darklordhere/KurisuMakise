from KurisuMakise import RINTAROU, MAKISE_OWN, MAYURI
...
class CustomFilters(object):
    ...
    class _Supporters(BaseFilter):
        ...
        def filter(self, message: Message):
            return bool(message.from_user and message.from_user.id in MAYURI)
    ...
    class _Sudoers(BaseFilter):
        ...
        def filter(self, message: Message):
            return bool(message.from_user and message.from_user.id in MAKISE_OWN)
    ...
    class _Developers(BaseFilter):
        ...
        def filter(self, message: Message):
            return bool(message.from_user and message.from_user.id in RINTAROU)
