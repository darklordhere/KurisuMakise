...
import KurisuMakise.plugins.sql.users_sql as sql
from KurisuMakise import RINTAROU, LOGGER, OWNER_ID, dispatcher
from KurisuMakise.plugins.helper_funcs.chat_status import dev_plus, sudo_plus
from KurisuMakise.plugins.sql.users_sql import get_all_users

USERS_GROUP = 4
CHAT_GROUP = 5
DEV_AND_MORE = RINTAROU.append(int(OWNER_ID))
